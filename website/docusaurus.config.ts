...
const config: Config = {
  ...
  projectName: 'q4-book-hackathon', // Usually your repo name.
  ...
  stylesheets: [
    {
      ...
      type: 'text/css',
      integrity:
        'sha384-odtC+0UGzzFL/6QkHlJ2imq5pHyMA2ptwoZ00sQ8/83tq91Bxm8fGGNS1h8+0In',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Instagram',
              href: 'https://www.instagram.com/haris.awan07',
            },
          ],
        },
        {
